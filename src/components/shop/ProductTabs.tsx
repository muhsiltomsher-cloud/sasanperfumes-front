...
export function ProductTabs({
  ...
  return (
    <div className="mt-12 border-t border-brand-primary/15 pt-8">
      ...
      <div className="py-6">
        {activeTab === "description" && hasDescription && (
          <div
            className="prose prose-stone max-w-none prose-headings:text-brand-primary prose-p:text-gray-700 prose-strong:text-brand-primary prose-li:text-gray-700"
        ...
        {activeTab === "additional" && hasAttributes && (
          <div className="overflow-x-auto">
            <table className="w-full">
              <tbody className="divide-y divide-brand-primary/15">
                {attributes.map((attr) => (
                  <tr key={attr.id}>
                    <th className="py-3 pe-4 text-start text-sm font-medium text-brand-primary w-1/3">
                      {attr.name}
                    </th>
