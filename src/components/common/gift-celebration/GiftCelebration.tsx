    ...
    <div className="fixed inset-0 z-[200] pointer-events-none flex items-center justify-center">
      ...
      <div className="relative">
        ...
        >
          ...
          `}>
            <div className="absolute inset-0 bg-gradient-to-br from-brand-primary via-orange-500 to-red-500 rounded-2xl shadow-2xl transform rotate-3" />
            <div className="absolute inset-0 bg-gradient-to-br from-brand-primary via-orange-400 to-red-400 rounded-2xl shadow-xl" />
          ...
          {(animationPhase === "celebrate") && (
            <div className="mt-6 text-center animate-slide-up">
              <div className="bg-white/95 backdrop-blur-sm rounded-2xl px-8 py-4 shadow-2xl border border-brand-primary">
                <div className="flex items-center justify-center gap-2 mb-2">
                  <span className="text-2xl">🎁</span>
                  <h3 className="text-xl font-bold bg-gradient-to-r from-brand-primary to-orange-600 bg-clip-text text-transparent">
                ...
                {giftName && (
                  <p className="text-brand-gold font-semibold mt-1 text-sm">
                    {giftName}
                  </p>
                )}
              </div>
