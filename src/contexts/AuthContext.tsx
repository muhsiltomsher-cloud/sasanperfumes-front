...
const AUTH_TOKEN_KEY = "sasanperfumes_auth_token";
const AUTH_USER_KEY = "sasanperfumes_auth_user";
const AUTH_REFRESH_TOKEN_KEY = "sasanperfumes_refresh_token";
const AUTH_WP_TOKEN_KEY = "sasanperfumes_wp_auth_token";
